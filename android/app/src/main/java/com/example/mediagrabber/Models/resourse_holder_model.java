...
public class resourse_holder_model {
    ...
    {
        add_video_files(new Downloadable_resource_model(name,link, FileType.VIDEO,size));
    }

    public void add_Image (String size, String type, String link, String name, String page)
    {
        add_image_files(new Downloadable_resource_model(name,link, FileType.IMAGE,size));
    }

    public void add_Audio (String size, String type, String link, String name, String page)
    {
        add_audio_file(new Downloadable_resource_model(name,link, FileType.AUDIO,size));
    }
    ...
    public void check_and_add_file(String url){
        try {
            ...
            if(video_types.contains(extension)){
                add_video_files(new Downloadable_resource_model(this.page_title,url, FileType.VIDEO,null));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
